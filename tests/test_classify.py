...
class SentinelClassifierTest(TestCase):
    ...
    def setUp(self):
        ...
        self.cloud = TrainingSample.objects.create(
            geom='SRID=3857;POLYGON((-1018837.41804578655865043 4681950.11229053698480129, -1018827.51977046544197947 4681934.33691424410790205, -1018828.60239432868547738 4681955.9893915094435215, -1018837.41804578655865043 4681950.11229053698480129))',
            category='Cloud',
            value=2,
        ...
        self.shadow = TrainingSample.objects.create(
            geom='SRID=3857;POLYGON((-1018826.74646770604886115 4681954.90676764585077763, -1018825.81850439461413771 4681934.49157479591667652, -1018816.84819238481577486 4681934.80089589953422546, -1018819.47742176707834005 4681955.52540985401719809, -1018826.74646770604886115 4681954.90676764585077763))',
            category='Shadow',
            value=1,
            traininglayer=self.traininglayer,
            composite=self.composite,
