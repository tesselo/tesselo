...
class Classifier(models.Model):
    ...
    band_names = models.CharField(max_length=500, default='B02,B03,B04,B05,B06,B07,B08,B8A,B09,B10,B11,B12', help_text='Comma-separated list of band names and layer ids. If an integer value is added, it is assumed to be a rasterlayer id that should be included in the export.')
